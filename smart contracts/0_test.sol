...
contract bn256test{
    ...
    uint256 fsk1_oi = 8;//uint256(keccak256("fsk1_oi"));
    uint256 sk1_j = 7;//uint256(keccak256("sk1_j"));
    ...
    uint256 kw = 9;//uint256(keccak256("kw"));
    ...
    function test()public returns(bool)
    {
        ...
        G1Point memory TCi_ = G1Point(
        12244245392992519854491092634607597645100474138449617310653752179490597472399, 
        19413992270153072097071679426210296460390979110501244363249680701315100695770);
        
        G2Point memory Cj1_ = G2Point(
        ...
        G1Point memory TCj_ = G1Point(
        12027207001581717929778435304958195463391038467941835864287572135594135978190, 
        19170898236565769846451416901181205133395719787656724806695990424834935681820);
        
        G2Point memory Ci1_ = G2Point(
        [7273165102799931111715871471550377909735733521218303035754523677688038059653, 
        2725019753478801796453339367788033689375851816420509565303521482350756874229],
        [957874124722006818841961785324909313781880061366718538693995380805373202866, 
        2512659008974376214222774206987427162027254181373325676825515531566330959255]);
        
        return  pairing_check(TCi_, Cj1_, TCj_, Ci1_);
        
        // uint256 c = 11559732032986387107991004021392285783925812861821192530917403151452391805634;
        // uint256 d = 10857046999023057135944570762232829481370756359578518086990519993285655852781;
        // uint256 e = 4082367875863433681332203403145435568316851327593401208105741076214120093531;
        // uint256 f = 8495653923123431417604973247489272438418190587263600148770280649306958101930;
        
        // return BN256G2._isOnCurve(c, d, e, f);
    }
